...
import com.abc.abcmart.exception.ResourceNotFoundException;
...
public class OrderServiceImpl implements OrderService{
	...
	@Override
	public List<Order> getAllOrdersByCustomers(int customerId) {
	...
	@Override
	public Order createOrder(int customerId, List<OrderItemPayload> selectedProduct) {
		...
		for(OrderItemPayload po: selectedProduct) {
			 
			int productId = po.getProductId();
			int qty = po.getQuantity();
			Product product = productService.getProductById(productId);
			System.out.println("ItemTotal:"+product.getProductPrice());
