...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public List<Product> getProductsWithPriceRange(double minPrice, double maxPrice) {
		List<Product> products = productRepository.filterProductsWithInPriceRange(minPrice, maxPrice);
		return products;
	}
