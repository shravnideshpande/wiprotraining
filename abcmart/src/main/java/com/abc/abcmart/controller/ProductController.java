...
public class ProductController {
	...
	public List<Product> fetchProductWithInPrice(@PathVariable("sprice")double startPrice, @PathVariable("eprice")double endPrice){
		
		List<Product> products = productService.getProductsWithPriceRange(startPrice, endPrice);
		return products;
