...
import com.abc.abcmart.dao.ProductRepository;
...
public class ProductServiceTest {
	...
	public void testProductDetails() {
		...
		product.setProductName("ABcPro");
		product.setProductPrice(10000);
		product.setMfd(LocalDate.of(2001, 10, 10));
		...
		assertEquals("ABcPro",actualObj.getProductName());
	}
	...
	public void testGetAllProducts() {
		...
		product1.setProductName("ABCPhone");
		product1.setProductPrice(30000);
		product1.setMfd(LocalDate.of(2001, 10, 10));
		product1.setCategory("mobbi");
		
		Product product2 = new Product();
		product2.setProductId(333);
		product2.setProductName("ABCLaptop");
		product2.setProductPrice(20000);
		product2.setMfd(LocalDate.of(2001, 10, 10));
